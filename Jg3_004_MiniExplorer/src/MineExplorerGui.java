 ...
 * @author User
 */
public class MineExplorerGui extends javax.swing.JFrame
{

    /**
     * Creates new form MineExplorerGui
     */
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(MineExplorerGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new MineExplorerGui().setVisible(true);
            }
        });
    }
